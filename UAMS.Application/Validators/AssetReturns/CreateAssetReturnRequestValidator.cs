...
public class CreateAssetReturnRequestValidator
    : AbstractValidator<CreateAssetReturnRequestDto>
{
    public CreateAssetReturnRequestValidator()
    {
        RuleFor(x => x.AssetId)
            .NotEmpty()
        ...
        RuleFor(x => x.ReturnedById)
            .NotEmpty()
            .WithMessage("Returned by user is required.");

        RuleFor(x => x.ReceivedById)
            .NotEmpty()
            .WithMessage("Received by user is required.");
